...
return (ellipsis) => {
  ...
  function createAndRespond(department, location, description, urgency, notes, file, followUpUserId, updateChannel) {
    ...
    function formatOutput(successResult) {
      const fileText = successResult.fileInfo ? `[${successResult.fileInfo.filename}](${successResult.fileInfo.url})` : "<no file provided>";
